    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-slate-50">
      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-12 relative">
        ...
        <div className="absolute top-6 left-6 md:hidden flex items-center gap-2">
          <Image src="/fpt-logo.png" alt="FPT Logo" width={160} height={32} style={{ width: 'auto', height: '32px' }} className="object-contain" />
        </div>

        <div className="w-full max-w-md animate-slide-in-right">
          <div className="text-center mb-8 flex flex-col items-center">
            <Image src="/fpt-logo.png" alt="FPT Logo" width={280} height={64} style={{ width: 'auto', height: '64px' }} className="object-contain mb-6 hidden md:block" />
